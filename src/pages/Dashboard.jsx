...
export default function Dashboard() {
  ...
  return (
    <div className="min-h-screen bg-black text-zinc-200 font-sans selection:bg-brand/30">
      ...
      <main className="max-w-5xl mx-auto p-4 md:p-6 pb-24 flex flex-col items-center">
        {!data ? (
          ...
          <div className="w-full flex flex-col lg:flex-row gap-8 animate-in slide-in-from-bottom-8 duration-700 ease-out mt-2">
            ...
            {data.analisis && (
              <div className="w-full lg:w-1/2 bg-[#050505] border border-zinc-900/80 rounded-2xl p-6 md:p-8 flex flex-col h-fit sticky top-24">
